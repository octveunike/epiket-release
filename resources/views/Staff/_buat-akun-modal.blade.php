{{-- Modal: Buat Akun User inline (dipakai di Staff create/edit) --}}
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <select class="form-control">
                    <option selected>Petugas Piket</option>
                </select>
            </div>
            <div class="form-group">
...
(function () {
    ...
    const select    = document.getElementById('staff-user-select');
    const namaStaff = document.querySelector('input[name="nama_staff"]');
    ...
    window.openBuatAkunModal = function () {
        ...
        // Pre-fill Nama dari kolom Nama Staf kalau sudah terisi
        namaInput.value = (namaStaff && namaStaff.value) ? namaStaff.value : '';
    ...
    window.submitBuatAkun = async function () {
        ...
        try {
            ...
            // Push nama akun balik ke kolom Nama Staf supaya konsisten (tetap bisa diedit).
            if (namaStaff) namaStaff.value = user.nama;
