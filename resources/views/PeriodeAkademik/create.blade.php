...
<div class="page-header">
    <div>
        <div class="breadcrumb">Admin / <a href="{{ route('PeriodeAkademik.index') }}" style="color:var(--primary);">Data Periode Akademik</a> / Tambah</div>
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <select name="status" class="form-control">
                    <option value="0" {{ old('status', '0') == '0' ? 'selected' : '' }}>Non-Aktif</option>
...
<div class="confirm-overlay show" id="modalAktifError">
    <div class="confirm-box">
        ...
        Hanya boleh 1 periode aktif. Ubah status ke Non-Aktif atau edit periode yang sudah aktif.</p>
