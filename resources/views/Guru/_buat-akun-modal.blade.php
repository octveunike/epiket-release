{{-- Modal: Buat Akun User inline (dipakai di Guru create/edit) --}}
...
(function () {
    ...
    const select    = document.getElementById('guru-user-select');
    const namaGuru  = document.querySelector('input[name="nama_guru"]');
    ...
    window.openBuatAkunModal = function () {
        ...
        // Pre-fill Nama dari kolom Nama Guru kalau sudah terisi
        namaInput.value = (namaGuru && namaGuru.value) ? namaGuru.value : '';
    ...
    window.submitBuatAkun = async function () {
        ...
        try {
            ...
            // Push nama akun balik ke kolom Nama Guru supaya konsisten (tetap bisa diedit).
            if (namaGuru) namaGuru.value = user.nama;
